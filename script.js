            ...
            if( window.event.keyCode == 13 ){
                ...
                if (q == '') {
                    $.get(
                        ...
                        q: q0,
                        type:'video',
                        key: 'AIzaSyCJRI6ANgqNY3GswCGQ1kkLjpSxm9az7qQ'},
                        function(data){
        ...
        function shows(json) {
            if (json.results.length != 0) {
                ...
                for (var i = 0, len = json.results.length; i < len; i++) {
                    ...
                    http += '<i class="fas fa-arrow-left" id="past" title="戻る" style="margin-left: 5px;" onclick="searchpage()"></i><br><br>';
                    ...
                    http += '<div class="repeat-btns"><p style="text-align: center;"><span><i class="fas fa-tv" id="icon0" style="margin: 25px;" title="関連曲"></i></span><span><i style="margin: 25px" class="fas fa-microphone-alt" id="icon0" title="歌詞"></i></span><span><button class="play-pause" id="' + re.trackId + '" onclick="ok(this.id)" style="margin: 25px"><i title="再生" style="cursor: pointer;" class="fa fa-play"></i></button></span><span><i onclick="uuu()" title="お気に入り" class="fas fa-star" style="margin: 25px" id="icon0"></i></span><span><i style="margin: 25px" id="icon0" title="ダウンロード" class="fas fa-download"></i></span></p></div>'
                    http += '<br><br><br></div>';
                }
                http += '</div>';
            }
        ...
        function shows1(json) {
            if (json.results.length != 0) {
                ...
                for (var i = 0, len = json.results.length; i < len; i++) {
                    ...
                    httppp += '<div class="repeat-btns"><p style="text-align: center;"><span><i class="fas fa-tv" id="icon0" style="margin: 25px;" title="関連曲"></i></span><span><i style="margin: 25px" class="fas fa-microphone-alt" id="icon0" title="歌詞"></i></span><span><button class="play-pause" id="' + re.trackId + '" onclick="ok(this.id)" style="margin: 25px"><i title="再生" style="cursor: pointer;" class="fa fa-play"></i></button></span><span><i title="お気に入り" onclick="uuu()" class="fas fa-star" style="margin: 25px" id="icon0"></i></span><span><i style="margin: 25px" id="icon0" title="ダウンロード" class="fas fa-download"></i></span></p></div>'
                    httppp += '<br><br><br></div>';
                }
                httppp += '</div>';
            }
                ...
                "https://www.googleapis.com/youtube/v3/videos?id=" +clicked_id + "&key=AIzaSyCJRI6ANgqNY3GswCGQ1kkLjpSxm9az7qQ&part=snippet,contentDetails,statistics,status",{
                    ...
                    function(data){
                        ...
                        window.defaultStatus = "今、" + title + "が、流れています。"
                            ...
                            var underput = '<i class="fas fa-arrow-left" id="past" style="margin-left: 5px;" title="戻る" onclick="searchpage()"></i><br><br><p style="text-align: center;"><iframe frameborder="0" src="https://www.youtube.com/embed/' + clicked_id + '" style="width: 70%;height: 400px;margin-top: 10px;"></iframe></p>' +
                            '<div class="xxx"><h2 style="color: white;margin-top: 45px;text-align: center;">' + title + '</h2>' + 
                            '<div style="text-align: center;margin-top: 30px;"><div class="seek"><div class="fill"></div></div><div class="time">00:00 <span>/</span> 00:00</div>' + 
                            ...
                            console.log("この曲のidは、" + videoId + "です。");
                        });
                    }
            );
        }
